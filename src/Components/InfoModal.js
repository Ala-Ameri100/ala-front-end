    ...
    return (
        <>
          <Modal show={props.modalOpen} onHide={props.handleModalOpen}>
              ...
              <Modal.Body>
                 <p >
                <b>Welcome to Ameri100 Learning App</b> <br></br><br></br>  You can begin with selecting a Topic to start learning. <br></br> You will get a set of questions based on the Topic and Difficulty level that you choose. 
